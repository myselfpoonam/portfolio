    ...
    <div>
      <div className="hidden  xl:flex flex-col top-[35%] md:left-0 fixed p-4">
        <ul className="text-black text-3xl  ">
          <li className="flex justify-center p-10 ml-[-170px] items-center w-60 h-12 px-4   hover:ml-[-10px] hover:rounded-xl duration-300 backdrop-blur-xl bg-white/30 shadow-2xl ">
          ...
          <li className="flex justify-center  p-10 items-center ml-[-170px] w-60 h-12 px-4 hover:ml-[-10px] hover:rounded-xl duration-300 backdrop-blur-xl bg-white/30 shadow-2xl">
            <a href="" className="flex justify-between items-center w-full ">
              Github
